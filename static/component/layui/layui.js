          ...
          switch (
            ...
            case 4:
              r || (s.content = [s.content, "body"]),
                ...
                (s.content =
                  s.content[0] + '<i class="layui-layer-TipsG"></i>'),
                delete s.title,
  ...
  (E.prototype.config = {
    ...
    (f.spread = function (e, i) {
      ...
      n(e, t),
        t &&
          i &&
          layui.each(e.siblings("." + d), function (e, i) {
            n(c(i), !1);
          });
    }),
    (n = c(window)),
              ...
              v.length &&
                (!o.initSort ||
                  ...
                  ((m = o.initSort).type
                    ...
                    : layui.sort(v, B.config.indexName, null, !0)),
                c.initData(y[s.children], y[Y]),
